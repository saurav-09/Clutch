...
const StoryViewer = ({ viewStory, setViewStory }) => {
  ...
  return (
    <div
      className="fixed inset-0 w-screen h-screen bg-black/90 z-[110] flex items-center justify-center overflow-hidden"
      style={{
        backgroundColor:
    ...
    >
      ...
      <button
        onClick={handleClose}
        className="absolute top-4 right-4 text-white z-[120] focus:outline-none"
      >
