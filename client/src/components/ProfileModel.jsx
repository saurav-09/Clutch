        ...
        <div className="bg-white rounded-lg shadow p-6 ">
          ...
          <form className="space-y-4" onSubmit={(e)=>toast.promise(
           ...
           <label htmlFor="profile_picture" className='block text-sm font-medium text-gray-700 mb-1'>
            ...
            Profile Picture
           <input type="file" id='profile_picture' accept='image/*' hidden className='w-full p-3 border border-gray-200 rounded-lg' 
           onChange={(e) =>
            setEditForm({
          ...
          <div className="flex flex-col items-start gap-3">
           ...
           Cover Photo 
           <input type="file" id='cover_photo' accept='image/*' hidden className='w-full p-3 border border-gray-200 rounded-lg' 
           onChange={(e) =>
            setEditForm({
              ...editForm, // keep all other fields the same
          ...
          <div className="group/cover relative">
           ...
           <div className="">
            ...
            <input type="text" placeholder='Please enter your full name' className='w-full p-3 border border-gray-200 rounded-lg' onChange={(e)=>setEditForm({...editForm,full_name:e.target.value})} value={editForm.full_name}/>
           </div>
           <div className="">
            <label htmlFor="text" className='block text-sm font-medium text-gray-700 mb-1'>
             Username
           ...
           <div className="">
            ...
            placeholder='Please enter a short bio'onChange={(e)=>setEditForm({...editForm,bio:e.target.value})} value={editForm.bio}/>
           </div>
